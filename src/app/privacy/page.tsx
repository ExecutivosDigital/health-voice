...
export default function Privacy() {
  return (
    <div className="mx-auto flex h-full w-full max-w-[1280px] flex-col gap-2 p-2 pb-8 text-sm text-black">
      ...
      <span className="pl-4">
        b) Compartilhar, distribuir, replicar ou comercializar o conteúdo gerado
        pelo Aplicativo sem a devida autorização e/ou consentimento das partes
        envolvidas;
      </span>
      <span className="pl-4">
        c) Violar ou tentar violar a segurança do Aplicativo, incluindo, mas não
        se limitando a, acesso não autorizado a sistemas, dados ou contas;
      </span>
      <span className="pl-4">
        d) Modificar, adaptar, traduzir, fazer engenharia reversa, descompilar,
      ...
      <span>
        4.4. O Usuário reconhece que o Health Voice é uma ferramenta de suporte
        e que a verificação da precisão das transcrições, a categorização e a
        ...
        exatidão, completude ou infalibilidade das transcrições automáticas ou
        da identificação de interlocutores, as quais devem ser sempre revisadas
        e validadas pelo Usuário.
      </span>
